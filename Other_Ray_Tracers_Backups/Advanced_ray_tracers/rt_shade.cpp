...
float intersectCylinder(SbVec3f rayOrig,SbVec3f rayDirection,my_cylinder cylinder, int locCylinder)
 {
	 ...
	 SbVec3f rayO,rayD;
	 rayO = SbVec3f(rayOrig[0],0,rayOrig[2]);
	 rayD = SbVec3f(rayDirection[0],0,rayDirection[2]);
    ...
    //C = rayOrig[0] * rayOrig[0] + rayOrig[2] * rayOrig[2] -1;// 1 is radius here. 
	 ...
	 //rayD.normalize();
	 A = rayD.dot(rayD);
	 B = 2*(rayO.dot(rayD)-cylinder.centerCylinder[locCylinder].dot(rayD));
	 C = rayO.dot(rayO) + cylinder.centerCylinder[locCylinder].dot(cylinder.centerCylinder[locCylinder]) - 2*(rayO.dot(cylinder.centerCylinder[locCylinder]))-cylinder.radius[locCylinder]*cylinder.radius[locCylinder];
